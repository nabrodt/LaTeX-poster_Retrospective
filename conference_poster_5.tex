...
\begin{minipage}[b]{0.55\linewidth}
    \huge \color{NavyBlue} \textbf{Scrum-Retrospektive} \color{Black}\\ % Title
    \huge\textit{Der Schlüssel zur kontinuierlichen Verbesserung}\\[1cm] % Subtitle
    %\Large\textit{}\\[1cm]
    \huge \textbf{Sahin Karakoc, Johannes Graff, Fabian Zeller, Gerhard Goetz, Nadina Brodt}\\ % Author(s)
